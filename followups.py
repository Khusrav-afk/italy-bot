...
DEFAULT_MESSAGES = {
    "m1": "Вы ещё думаете? Могу подсказать по деталям или подобрать вариант под ваш запрос.",
    "m2": "Напомню о себе - если удобно, продолжим подбор. Что вас интересовало?",
    "m3": "Всё ещё актуально? Могу подобрать варианты, если подскажете детали.",
    "m4": "Не хочу потерять ваш запрос. Подскажите, актуально ли ещё - "
          "подберём для вас лучший вариант.",
}
