...
SUBAGENTS = {
    ...
    "ЕСЛИ ГРУППОВЫЕ - дай ссылку на бронь групповых из знаний направления (старт от Punta Sabbioni "
    "или из Венеции), предложи помощь; при интересе возьми имя и контакт. "
    ...
    "уже бывал; 3) сколько человек; 4) если есть дети - их возраст; 5) желаемые даты. Затем выдай "
    "блок КРАТКИЙ СПИСОК из знаний направления ДОСЛОВНО, включая завершающую фразу. Когда клиент "
    "выбрал - выдай ДОСЛОВНО описание выбранной из блока ПОДРОБНОЕ ОПИСАНИЕ. После подробностей НЕ "
    "повторяй завершающую фразу из списка - сразу веди к брони: предложи забронировать и подскажи "
    "рекомендованное время начала (по умолчанию 10:00, тур стартует с 09:00). Время начала бери из "
    "знаний направления. Для русского - слово в слово; для другого языка переведи, сохраняя цены, "
    "названия и ссылки. Затем подведи к брони "
    "(предоплата 50 евро). Если "
    "выбраны экскурсия + дата + время + имя + контакт - добавь блок брони (клиент не увидит):\n"
    '[BOOKING]{"title":"","datetime":"2026-07-15T10:00:00","duration_min":120,"name":"","contact":"","people":"","notes":""}[/BOOKING]\n'
